...
async function inspectTemplate() {
  ...
  console.log("Inspecting client_greeting template details from Meta API...");
  const url = `https://graph.facebook.com/v23.0/${wabaId}/message_templates?name=client_greeting`;
  const headers = {
